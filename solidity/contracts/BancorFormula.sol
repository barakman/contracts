...
contract BancorFormula is IBancorFormula, SafeMath {
    ...
    */
    ...
    /**
        ...
        The exponentiation function "fixedExpUnsafe(x)", which calculates "e ^ x", is limited to a maximum value of "x".
        The limit depends on the precision, and "maxExpArray" maps each precision between 0 and 127 to the maximum value permitted.
